...
python train_net.py --config $config \
 ...
 MODEL.SEM_SEG_HEAD.SAMPLE_CLASSES_NUM "32" \
 INPUT.CROP.SIZE \($size\,\ $size\) \
...
python train_net.py --config $config \
 ...
 MODEL.SEM_SEG_HEAD.SAMPLE_CLASSES_NUM "48" \
 INPUT.CROP.SIZE \($size\,\ $size\) \
 MODEL.WEIGHTS $output/model_final.pth \
 $opts
...
python train_net.py --config $config \
 ...
 MODEL.SEM_SEG_HEAD.SAMPLE_CLASSES_NUM "16" \
 INPUT.CROP.SIZE \($size\,\ $size\) \
 MODEL.WEIGHTS $output/model_final.pth \
 $opts
...
python train_net.py --config $config \
 ...
 MODEL.SEM_SEG_HEAD.SAMPLE_CLASSES_NUM "24" \
 INPUT.CROP.SIZE \($size\,\ $size\) \
 MODEL.WEIGHTS $output/model_final.pth \
 $opts
